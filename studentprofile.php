...
$userId = isset($_GET['id']) ? $_GET['id'] : $user->data()->id; // Use the provided ID or the logged-in user's ID
...
<head>
    ...
    <title>CEU socmed Portal</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Montserrat&display=swap" rel="stylesheet">
    <script src="https://code.jquery.com/jquery-.2.4.js" integrity="sha256-iT6Q9iMJYuQiMWNd9lDyBUStIq/8PuOW33aOqmvFpqI=" crossorigin="anonymous"></script>
...
<body>
    <?php require_once("nav/studentnav.php") ?>
    <div class="container-fluid mt-4 puff-in-center">
        <div class="row">
            <div class="col-md-2 border pr-5">
                <!-- Profile Section -->
                <?php profilePic() ?>
                <h6 class="text-center mt-4 text-dark">Account Name: <?php echo $user->data()->name ?> </h6>
                <h6 class="text-left mt-4 text-dark">Account Registered: <br><?php echo $user->data()->joined ?> </h6>
                <h6 class="text-left mt-4 text-dark">Account Email: <br><?php echo $user->data()->email ?> </h6>
            </div>
            <!-- Middle Section -->
            <div class="col-md-8 border pr-5">
                ...
                <div class="timeline-container">
                    <!-- Display only the posts of the specific account -->
                    <?php $viewtable->viewUserPosts($userId); ?>
                </div>
            </div>
            <div class="col-md-2 border pr-5">
                <h4 class="text-danger">Registered Users of this Site: </h4>
